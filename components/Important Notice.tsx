        ...
        <div className="p-6">
          ...
          <div className="max-h-[480.35px] overflow-y-auto">
            <ul className="text-white-300 leading-8 pl-6 list-inside">
              <li><span className="chevron text-red-500">&gt;</span> Our office will be closed on December 25th in observance of Christmas Day.</li>
              <li><span className="chevron text-red-500">&gt;</span> Another important notice goes here...</li>
              <li><span className="chevron text-red-500">&gt;</span> Another important notice goes here...</li>
              <li><span className="chevron text-red-500">&gt;</span> Another important notice goes here...</li>
              <li><span className="chevron text-red-500">&gt;</span> Another important notice goes here...</li>
              <li><span className="chevron text-red-500">&gt;</span> Another important notice goes here...</li>
